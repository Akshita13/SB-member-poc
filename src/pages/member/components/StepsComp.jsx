    ...
    <>
      ...
      <Steps size="small" current={currentStep}>
        <Step
          ...
          description="Let's start with general settings your memership portal"
        ></Step>
        <Step
          className="link"
          ...
          description="Configure Talk to us section content"
        ></Step>
        <Step
          className="link"
          ...
          key="3"
          title="Addons"
          description="Enable/Disable permissions for your memership portal"
        ></Step>
        <Step
          className="link"
          ...
          key="4"
          title="UI & Theming"
          description="Configure store and theme for your memership portal"
        ></Step>
      </Steps>
...
export default connect(({}) => ({}))(StepsComp);
